...
(Esto responde a “relación origin vs mpg” con medias y dispersión por origen.)
...
* Repara el desastre `origin + car_name` en una sola columna.
* Deja `origin` como factor (`usa`, `europe`, `japan`) y `name` como string limpio.
* Hace el EDA completo (univariado, bivariado y gráficos).
* Guarda el dataset limpio en formato Feather como te piden.
